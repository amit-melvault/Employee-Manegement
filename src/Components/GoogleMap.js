    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 1000 }}>
                <h4 className="mapHeading">Google Map Basic</h4>
                ...
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDWkgx57etjSHy7sZ-PsuXN7PbuP9jVW70&libraries=places"
                    loadingElement={
                        <div style={{ height: `50%` }} />
                    }
                    containerElement={
